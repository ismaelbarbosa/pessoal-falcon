object frmSelLotacao: TfrmSelLotacao
  Left = 309
  Top = 276
  Width = 935
  Height = 386
  BorderIcons = [biSystemMenu]
  Caption = 'Selecionar a Lota'#231#227'o'
  Color = clBtnFace
  ...
  object gbxLotacao: TcxGroupBox
    ...
    object Label1: TLabel
      ...
      Width = 332
      Height = 16
      Caption = 'Digite a descri'#231#227'o, sigla, superlota'#231#227'o  ou c'#243'digo:'
      Font.Charset = ANSI_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
      Font.Name = 'Verdana'
  ...
  object grpbxSelLotacaoBotoes: TcxGroupBox
    Left = 0
    Top = 292
    Align = alBottom
    Style.BorderStyle = ebsNone
  ...
  object grdLotacao: TcxGrid
    ...
    Align = alClient
    TabOrder = 2
    object tbvLotacao: TcxGridDBTableView
      OnDblClick = tbvLotacaoDblClick
      ...
      object tbvSigla: TcxGridDBColumn
        Caption = 'Sigla'
        DataBinding.FieldName = 'sigla'
        Width = 200
      end
      object tbvSuperLotacao: TcxGridDBColumn
        Caption = 'Superlota'#231#227'o'
        DataBinding.FieldName = 'superlotacao'
        Width = 100
      end
      object tbvIdLotacao: TcxGridDBColumn
        DataBinding.FieldName = 'idLotacao'
      end
    end
    object lvlLotacao: TcxGridLevel
      GridView = tbvLotacao
    end
  end
  object tmrSelLotacao: TTimer
    Enabled = False
    Interval = 600
    OnTimer = tmrSelLotacaoTimer
    Left = 344
    Top = 161
  end
