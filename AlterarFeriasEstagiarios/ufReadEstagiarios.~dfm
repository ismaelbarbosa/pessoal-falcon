object frmReadEstagiarios: TfrmReadEstagiarios
  Left = 192
  Top = 117
  Width = 1044
  Height = 540
  Caption = 'Alterar matriculas dos estagi'#225'rios'
  Color = clBtnFace
  ...
  object pnlBotoes: TPanel
    ...
    object btnEditarMatricula: TcxButton
      Left = 2
      Top = 5
      Width = 110
      Height = 35
