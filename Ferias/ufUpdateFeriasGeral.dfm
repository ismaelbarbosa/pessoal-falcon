object frmUpdateFeriasGeral: TfrmUpdateFeriasGeral
  Left = 1
  Top = 1
  Width = 1022
  Height = 726
  Caption = 'F'#233'rias de servidores e procuradores'
  Color = clBtnFace
  ...
  object pgcFerias: TcxPageControl
    Left = 0
    Top = 164
    Width = 1014
    Height = 531
    ActivePage = tshRelacaoFerias
    Align = alClient
    TabOrder = 1
    ...
    object tshRelacaoServidores: TcxTabSheet
      ...
      object grdServidores: TcxGrid
        ...
        object tbvServidores: TcxGridDBTableView
          OnDblClick = tbvServidoresDblClick
    ...
    object tshRelacaoFerias: TcxTabSheet
      Caption = '&2. Rela'#231#227'o de f'#233'rias do servidor'
      ImageIndex = 1
      OnShow = tshRelacaoFeriasShow
      object pnlCRUDFerias: TPanel
        Left = 0
        Top = 0
        Width = 1014
        Height = 196
        ...
        object DBText1: TDBText
          ...
          AutoSize = True
          DataField = 'ID'
          DataSource = dmFeriasAbonoAfastamento.dsFerias
          Font.Charset = ANSI_CHARSET
          Font.Color = clGray
          Font.Height = -11
          Font.Name = 'Verdana'
        ...
        object txtDescricaoPeriodo: TDBText
          Left = 232
          Top = 56
          Width = 72
          Height = 13
        ...
        object txtdescricaoParcela: TDBText
          Left = 91
          Top = 80
          Width = 61
          Height = 17
          DataField = 'descricaoParcela'
          DataSource = dmFeriasAbonoAfastamento.dsFerias
          Font.Charset = ANSI_CHARSET
          Font.Color = clBlue
          Font.Height = -11
        ...
        object txtDescricaoTipo: TDBText
          Left = 291
          Top = 80
          Width = 68
          Height = 17
        ...
        object txtIdTipoParcela: TDBText
          Left = 272
          Top = 80
          Width = 16
          Height = 17
          DataField = 'idTipoParcela'
          DataSource = dmFeriasAbonoAfastamento.dsFerias
          Font.Charset = ANSI_CHARSET
          Font.Color = clBlue
          Font.Height = -11
        ...
        object txtNProcessoSEI: TDBText
          Left = 91
          Top = 105
          Width = 174
          Height = 17
          DataField = 'nProcessoSEI'
          DataSource = dmFeriasAbonoAfastamento.dsFerias
          Font.Charset = ANSI_CHARSET
          Font.Color = clBlue
          Font.Height = -11
        ...
        object txtDt_InicioReagendamento: TDBText
          Left = 502
          Top = 129
          Width = 80
          Height = 17
        ...
        object txtDt_TerminoReagendamento: TDBText
          Left = 750
          Top = 129
          Width = 80
          Height = 17
        ...
        object Label11: TLabel
          ...
          Width = 125
          Height = 13
          Caption = 'In'#237'cio reagendamento'
        end
        object Label12: TLabel
          ...
          Width = 141
          Height = 13
          Caption = 'T'#233'rmino reagendamento'
        end
        ...
        object Label7: TLabel
          ...
          Width = 99
          Height = 13
          Caption = 'Abono pecuni'#225'rio'
        end
        object txtAbonoPecuniario: TDBText
          Left = 459
          Top = 105
          Width = 133
          Height = 17
          DataField = 'AbonoPecuniario'
          DataSource = dmFeriasAbonoAfastamento.dsFerias
          Font.Charset = ANSI_CHARSET
          Font.Color = clBlue
          Font.Height = -11
      ...
      object grdFerias: TcxGrid
        ...
        object tbvFerias: TcxGridDBTableView
          ...
          object tvcAbonoPecuniario: TcxGridDBColumn
            Caption = 'Abono'
            DataBinding.FieldName = 'AbonoPecuniario'
            Width = 70
          end
