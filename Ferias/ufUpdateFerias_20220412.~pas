...
type
  TfrmUpdateFerias_20220412 = class(TForm)
    pnlBotoes: TPanel;
    Label2: TLabel;
    btnSair: TcxButton;
    btnGravar: TcxButton;
...
var
  frmUpdateFerias_20220412: TfrmUpdateFerias_20220412;
...
procedure TfrmUpdateFerias_20220412.btnSairClick(Sender: TObject);
begin
  if btnSair.Focused then Close;
end;

procedure TfrmUpdateFerias_20220412.FormActivate(Sender: TObject);
begin
  Position := poScreenCenter;
  //if edtExercicio.Enabled then edtExercicio.SetFocus;

  if rgpPeriodo.Enabled then rgpPeriodo.SetFocus;
...
function TfrmUpdateFerias_20220412.retornaDataTermino(Data: TDate; TipoParcela: String; Parcela: Integer): TDate;
var aSomar: integer;
begin
...
function TfrmUpdateFerias_20220412.retornarFeriasTipoParcela(idxParcela: Integer): boolean;
var wSQL: String;
begin
    ...
    try
      ...
      begin
        ...
        + ' WHERE idTipoParcela in (';
          ...
          //ShowMessage(IntToStr(idxParcela));
...
procedure TfrmUpdateFerias_20220412.lkpTipoParcelaExit(Sender: TObject);
begin
  lkpTipoParcelaClick(Nil);
end;

function TfrmUpdateFerias_20220412.setarOperacao(tipo: Integer): boolean;
begin
  OPERACAO := tipo;
  Result := true;
end;

procedure TfrmUpdateFerias_20220412.configurarOperacao;
begin
  case OPERACAO of
    1:      // Incluir férias
    begin
  ...
  begin
    ...
    begin
      ...
      //ItemIndex := 0;    // Não setar esse valor pois virá da função carregarFeriasParaEdiacao
    end;
  end;    
end;

procedure TfrmUpdateFerias_20220412.btnGravarClick(Sender: TObject);
...
function TfrmUpdateFerias_20220412.atualizarFerias: boolean;
begin
  try
...
function TfrmUpdateFerias_20220412.incluirFerias: boolean;
begin
  try
      with dmPessoal.qryExecSQL do
      begin
...
function TfrmUpdateFerias_20220412.retornaSQLInsertFerias(parcela: Integer): String;
...
function TfrmUpdateFerias_20220412.retornaSQLUpdateFerias: String;
var SQL_Ferias: String;
begin
  SQL_Ferias :=
      'SET DATEFORMAT dmy'
...
procedure TfrmUpdateFerias_20220412.edtDtInicioPrimeiraExit(Sender: TObject);
begin
...
procedure TfrmUpdateFerias_20220412.edtExercicioKeyPress(Sender: TObject;
  var Key: Char);
begin
  if not (key in ['0'..'9',#8]) then key := #0;
end;

function TfrmUpdateFerias_20220412.jaExisteFerias
...
function TfrmUpdateFerias_20220412.setFormQueChamou(Origem:String): Integer;
begin
...
function TfrmUpdateFerias_20220412.getFormQueChamou: Integer;
begin
  Result := FormQueChamou;
end;

procedure TfrmUpdateFerias_20220412.edtDtInicioPrimeiraEnter(Sender: TObject);
...
procedure TfrmUpdateFerias_20220412.edtExercicioExit(Sender: TObject);
var difAno: Integer;
...
{function TfrmUpdateFerias_20220412.exibeFeriasNoPeriodo(pIdPessoal, pIdServidor,
...
procedure TfrmUpdateFerias_20220412.FormCreate(Sender: TObject);
begin
...
procedure TfrmUpdateFerias_20220412.rgpParcelaClick(Sender: TObject);
begin
//  ShowMessage(IntToStr(rgpParcela.ItemIndex));
//  retornarFeriasTipoParcela(1);
  retornarFeriasTipoParcela(rgpParcelada.ItemIndex);
end;

procedure TfrmUpdateFerias_20220412.rgpParcelaExit(Sender: TObject);
var wPeriodo, wParcela, wMensagem: String;
begin
  case rgpPeriodo.ItemIndex of
   0: wPeriodo := 'U';
...
function TfrmUpdateFerias_20220412.carregarFeriasParaEdicao: boolean;
begin
  {with Ferias do
  begin
...
procedure TfrmUpdateFerias_20220412.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TfrmUpdateFerias_20220412.bloquearCampos;
begin
...
procedure TfrmUpdateFerias_20220412.desbloquearCampos;
begin
...
procedure TfrmUpdateFerias_20220412.rgpParceladaClick(Sender: TObject);
begin
  //ShowMessage('Clicado');
...
procedure TfrmUpdateFerias_20220412.rgpParceladaExit(Sender: TObject);
begin
  rgpParceladaClick(Nil);
end;

procedure TfrmUpdateFerias_20220412.setarGruposSegundaETerceira(modo:Integer);
var i : integer;
begin
  case modo of
    1: // habilita segunda
...
procedure TfrmUpdateFerias_20220412.edtDtInicioSegundaExit(Sender: TObject);
begin
...
function TfrmUpdateFerias_20220412.HaAfastamentosOuFeriasCoincidentes(dtInicio,
...
procedure TfrmUpdateFerias_20220412.setarGrupoPrimeira(modo: Integer);
var i : integer;
begin
  case modo of
    1: // habilita primeira
...
procedure TfrmUpdateFerias_20220412.setarGrupoSegunda(modo: Integer);
begin
  case modo of
    1: // habilita segunda
    begin
...
procedure TfrmUpdateFerias_20220412.setarGrupoTerceira(modo: Integer);
begin
  case modo of
    1: // habilita terceira
    begin
...
procedure TfrmUpdateFerias_20220412.lkpTipoParcelaClick(Sender: TObject);
begin
  //limparGrupoPrimeira;
...
procedure TfrmUpdateFerias_20220412.edtDtInicioTerceiraExit(Sender: TObject);
begin
...
procedure TfrmUpdateFerias_20220412.limparGrupoSegunda;
begin
...
procedure TfrmUpdateFerias_20220412.limparGrupoTerceira;
begin
...
procedure TfrmUpdateFerias_20220412.Button1Click(Sender: TObject);
begin
  limparGrupoSegunda;
end;

procedure TfrmUpdateFerias_20220412.limparGrupoPrimeira;
begin
...
function TfrmUpdateFerias_20220412.excluirFeriasDoExercicio: boolean;
begin
  try
      with dmPessoal.qryExecSQL do
      begin
...
function TfrmUpdateFerias_20220412.retornaSQLDeleteFerias: String;
...
procedure TfrmUpdateFerias_20220412.setarDadosServidor(Matricula, Nome, Cargo: String);
begin
...
function TfrmUpdateFerias_20220412.setarRegistroAGravar: boolean;
var registro: String;
begin
  {
