object frmUpdateFerias: TfrmUpdateFerias
  ...
  object gbxLancamento: TcxGroupBox
    ...
    object lkpTipoParcela: TcxLookupComboBox
      ...
      Properties.OnChange = lkpTipoParcelaPropertiesChange
    ...
    object rgpPeriodo: TcxRadioGroup
      ...
      Properties.OnChange = rgpPeriodoPropertiesChange
    ...
    object rgpParcelada: TcxRadioGroup
      ...
      Properties.OnChange = rgpParceladaPropertiesChange
      ItemIndex = 1
      Style.BorderStyle = ebsFlat
      Style.Font.Charset = ANSI_CHARSET
      Style.Font.Color = clWindowText
    ...
    object rgpAbonoPecuniario: TcxRadioGroup
      Left = 394
      Top = 45
      ...
      Style.IsFontAssigned = True
      TabOrder = 4
      OnClick = rgpAbonoPecuniarioClick
      Height = 47
      Width = 140
    end
    object Memo1: TMemo
      ...
      Lines.Strings = (
        'Quando '#233' '
        'selecionada a '
        'op'#231#227'o de Abono '
        'pecuni'#225'rio n'#227'o '
        'est'#225' gravando o '
        'valor SIM na '
        'tabelas'
        ''
        'Se j'#225' houver '
        'registro de f'#233'rias '
        'para o per'#237'odo '
        'informado, ent'#227'o '
        'ser'#225' aberta para '
        'edi'#231#227'o.'
  ...
  object cxGroupBox2: TcxGroupBox
    ...
    object gbxPrimeiraParcela: TcxGroupBox
      ...
      object edtDtInicioPrimeira: TcxDateEdit
        ...
        Top = 40
        ParentFont = False
        Properties.OnChange = edtDtInicioPrimeiraPropertiesChange
        Style.BorderStyle = ebsNone
        Style.Font.Charset = ANSI_CHARSET
        Style.Font.Color = clWindowText
        Style.Font.Height = -13
      ...
      object gbxReagendamentoPrimeira: TcxGroupBox
        Left = 8
        Top = 168
    ...
    object gbxSegundaParcela: TcxGroupBox
      ...
      object edtDtInicioSegunda: TcxDateEdit
        ...
        Top = 40
        ParentFont = False
        Properties.OnChange = edtDtInicioSegundaPropertiesChange
        Style.BorderStyle = ebsNone
        Style.Font.Charset = ANSI_CHARSET
        Style.Font.Color = clWindowText
        Style.Font.Height = -13
      ...
      object gbxReagendamentoSegunda: TcxGroupBox
        Left = 8
        Top = 168
        Caption = 'Reagendamento'
        Style.BorderStyle = ebsFlat
    ...
    object gbxTerceiraParcela: TcxGroupBox
      ...
      object edtDtInicioTerceira: TcxDateEdit
        ...
        Top = 40
        ParentFont = False
        Properties.OnChange = edtDtInicioTerceiraPropertiesChange
        Style.BorderStyle = ebsNone
        Style.Font.Charset = ANSI_CHARSET
        Style.Font.Color = clWindowText
        Style.Font.Height = -13
      ...
      object gbxReagendamentoTerceira: TcxGroupBox
        Left = 8
        Top = 168
        Caption = 'Reagendamento'
        Style.BorderStyle = ebsFlat
