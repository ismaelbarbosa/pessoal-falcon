{*-------------------------------------------------------------------------
 Rotinas genéricas para os sistemas da PGDF.
 Reúne os objetos necessários aos sistemas da PGDF, em especial os
responsáveis pelo Login dos sistemas construídos em Delphi.
...
type
{*-------------------------------------------------------------------------
Tipo que serve para informar à função 'MetodoVigenere' do objeto
'TCriptografia' qual a operação (criptografar: 'toCripto' ou
...
{*-------------------------------------------------------------------------
Responsável pela criptografia das senhas dos sistemas.
...
Repete a operação, com  valores diferentes, por três vezes.
...
@Param AOperacao Tipo de operação a ser realizada ('toCripto' ou 'toDecripto')
@Return A string 'ATexto' criptografada
===========================================================================}
    function MetodoVigenere(const ATexto: string; ASenha: string; AOperacao:
            TTipoOperacao): string;
{*-------------------------------------------------------------------------
Utiliza o método 'Criptografar' para atribuir um valor ao campo
...
===========================================================================}
  ...
  public
    { Public declarations }
{*-------------------------------------------------------------------------
Cria o objeto 'TCriptografia e passa o valor do parâmetro
...
{*-------------------------------------------------------------------------
Recebe uma string e passa-a para o campo 'fSenha_Criptografada' através do
método 'SetSenha'.
...
===========================================================================}
  ...
  {TAcesso interface}
{*-------------------------------------------------------------------------
 Responsável pela conexão ao banco de dados onde estão armazenadas as
senhas dos sistemas.
